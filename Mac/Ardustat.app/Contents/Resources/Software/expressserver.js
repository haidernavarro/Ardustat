...
function setStuff(req,res)
{
	...
	{	
		...
		mongoexportcmd = "cd ../mongodb/ && ./mongoexport -csv -o ../../../../CSVfiles/" + collectiontoexport + ".csv -d ardustat -c " + collectiontoexport + " -f time,cell_potential,working_potential,current"
...
function upload_firmware() {
	serialPort.close()
	exec("cd ../avrdude-bin && ./avrdude -C `pwd`/avrdude.conf -F -V -c arduino -p ATMEGA328P -P "+process.argv[2]+" -b 115200 -U flash:w:../Software/avrdude/firmware_12s.hex", 
