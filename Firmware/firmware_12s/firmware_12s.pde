...
void sendout()
{
  ...
  current_adc = betteranaread(4);
  other_current_adc = betteranaread(5);
  ...
  Serial.print(adcref);
  Serial.print(",");
  Serial.print(other_current_adc);
  Serial.print(",");
